...
describe('Database tests', function () {
    ...
    it('should return valid JSON for a random productID between 1 and 999999 for all routes', async function () {
    ...
    describe(`Performance measurements (${performanceTests} attempts x ${totalRoutes} fns)`, function () {
        this.timeout(10 * performanceTests * totalRoutes);
        it(`should measure and validate the performance of ${totalRoutes} tests x ${performanceTests} iterations per test`, async function () {
            ...
            for (let i = 1; i <= performanceTests; i++) {
                ...
                measurements.getProduct.push(duration1);
                ...
                measurements.getProducts.push(duration2);
                ...
                measurements.getStyles.push(duration3);
                ...
                measurements.getRelated.push(duration4);
            }
            ...
            for (let [key, values] of Object.entries(stats)) {
                ...
                console.log(`[${key} x${performanceTests}]: avg = ${avg}ms | slowest = ${max}ms | best = ${min}ms `);
